...
def main():
    ...
    can(adsets and adsets[0][1] == 'Nhom 1 · nu 40-55', 'đúng Nhóm 1', adsets)
    nham = json.loads(adsets[0][3]['targeting']) if adsets else {}
    can(nham.get('age_min') == 40 and nham.get('age_max') == 55,
        'nhắm đúng tuổi 40–55', (nham.get('age_min'), nham.get('age_max')))
    ...
    ten = [g[1] for g in fb.da_goi if g[0].endswith('/adsets') and not g[2]]
    can(ten == ['Nhom 1 · nu 40-55'], 'nhóm giảm mỡ nằm trong chiến dịch Q10', ten)
